...
enum ActualistDiagnosticReportBuilder {
    static func make(
        ...
        var lines: [String] = [
            ...
            "Credentials available: \(yesNo(appState.canUseAPI))",
            ...
            "",
            "[Capabilities]",
            "Create transactions: \(yesNo(appState.capabilities.canCreateTransactions))",
            "Categorize transactions: \(yesNo(appState.capabilities.canCategorizeTransactions))",
            "Update transactions: \(yesNo(appState.capabilities.canUpdateSimpleTransactions))",
            "Delete transactions: \(yesNo(appState.capabilities.canDeleteTransactions))",
            "Transfers: \(yesNo(appState.capabilities.canWriteTransfers))",
            "Splits: \(yesNo(appState.capabilities.canWriteSplits))",
            "Budget assignment: \(yesNo(appState.capabilities.canAssignCategoryBudget))",
            "Category rollover: \(yesNo(appState.capabilities.canSetCategoryCarryover))",
            ...
            "Transaction notifications: \(yesNo(appState.capabilities.supportsTransactionNotifications))",
            "",
